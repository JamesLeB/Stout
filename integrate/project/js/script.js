...
function getMarketStatus(){
	//$.get( "php/marketStatus.php", function(a){
	$.get( "php/marketStatus.html", function(a){
		$('#marketStatus').html(a);
...
function getMarketTrades(){
	//$.get( "php/marketTrades.php", function(a){
	$.get( "php/marketTrades.html", function(a){
		var json = $.parseJSON(a);
		var headings = [];
		headings.push("Id");
		headings.push("Time");
...
function getMarketBuyOrders(){
	//$.get( "php/marketBuyOrders.php", function(a){
	$.get( "php/marketBuyOrders.html", function(a){
		var json = $.parseJSON(a);
		var headings = [];
		headings.push("Id");
		headings.push("Price");
...
function getMarketSellOrders(){
	//$.get( "php/marketSellOrders.php", function(a){
	$.get( "php/marketSellOrders.html", function(a){
		var json = $.parseJSON(a);
		var headings = [];
		headings.push("Id");
		headings.push("Price");
